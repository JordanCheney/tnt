...
set(SIMDPP_X86_AVX_TEST_CODE
    ...
    #error Not supported. See tnt/deps/simd/detail/workarounds.h
    #endif
...
set(SIMDPP_X86_AVX512F_TEST_CODE
    ...
    #error GCC 5.x and older are not supported on AVX512F. See tnt/deps/simd/detail/workarounds.h
    #endif
    char* prevent_optimization(char* ptr)
    {
        volatile bool never = false;
...
set(SIMDPP_POWER_ALTIVEC_TEST_CODE
    ...
    #error GCC 5.0 and older are not supported on PPC little-endian. See tnt/deps/simd/detail/workarounds.h
    #endif
    #endif
    char* prevent_optimization(char* ptr)
    {
...
set(SIMDPP_POWER_VSX_206_TEST_CODE
    ...
    #error GCC 5.x and older not supported on VSX big-endian. See tnt/deps/simd/detail/workarounds.h
    #endif
    #endif
    char* prevent_optimization(char* ptr)
    {
...
#   macros defined in tnt/deps/simd/simd.h, which ultimately identify instruction set
